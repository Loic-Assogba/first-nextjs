export default function Vision() {
    return (
            <section className='mt-10 py-10 px-5 lg:px-15 flex flex-col justify-center items-center h-full w-full '>
               <div className="border bg-linear-to-b px-5 py-8  from-black from-10% to-[#7DD10F] to-50% w-full h-90 md:h-70 rounded-lg space-y-8">
